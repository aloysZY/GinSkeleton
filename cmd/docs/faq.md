...
#####  2.为什么该项目 go.mod 中的模块名是 ginskeleton ,但是下载下来的文件名却是 GinSkeleton ?
>   本项目一开始我们命名为 ginskeleton , 包名也是这个，但是后来感觉 ginskeleton 好听一点,因此改名（现在看是错了）,由于版本已经更新较多，同时不影响使用,此次失误请忽略即可.  
